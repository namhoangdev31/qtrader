...
| Missing `__init__.py` packages | **11** | 🟡 WARNING |
...
| Audit Export (CSV/FIX) | ⚠️ | `audit/compliance_exporter.py` | **Orphaned** |
| Regulatory Reporting | ⚠️ | `audit/regulatory_export.py` | **Orphaned** |
