#!/usr/bin/env python3
"""
Test script for Strategy layer upgrade to probabilistic signaling.
"""
...
class ProbabilisticStrategy(Strategy):
    ...
    def compute_signals(self, features: dict[str, pl.Series]) -> SignalEvent:
        ...
        """
        # Validate input features (reuse base validation)
        if not features:
...
def main():
    """Run all tests."""
    print("Testing Strategy Layer Upgrade to Probabilistic Signaling...\n")
