        ...
        return {
            ...
            "RiskEngine": {
                **(kill_switch.get_trace() if hasattr(kill_switch, "get_trace") else {}),
                ...
                "status": "HALTED" if (hasattr(kill_switch, "is_system_halted") and kill_switch.is_system_halted()) else "OK"
            },
            "RiskGuard": {
            ...
            "StrategyState": {
                ...
                "is_circuit_broken": state.consecutive_losses >= config_manager.get("MAX_CONSECUTIVE_LOSSES", 5)
            }
        }
