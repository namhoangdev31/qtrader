...
LOWER_BOUND_IDX = 1
UPPER_BOUND_IDX = 7
NDIM_BATCH_VARIATE = 3
NDIM_QUANTILES_ONLY = 2
...
class ChronosForecastAdapter:
    def __init__(
        self, model_id: str = "amazon/chronos-2", device: str = "auto", hf_token: str | None = None
    ) -> None:
    ...
    def _load_model(self) -> None:
        ...
        try:
            ...
            self._pipeline = Chronos2Pipeline.from_pretrained(self.model_id, **load_kwargs)
    ...
    def predict(
        ...
        if self._pipeline is not None:
            forecast_list = self._pipeline.predict(
                prices.reshape(1, 1, -1), prediction_length=prediction_length
            )
