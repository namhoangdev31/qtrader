...
def test_rolling_zscore_mean_approx_zero() -> None:
    import polars as pl
    from qtrader.input.features.statistical.transforms import rolling_zscore
...
def test_information_coefficient_perfect() -> None:
    import polars as pl
    from qtrader.input.features.statistical.transforms import information_coefficient
...
def test_winsorize_clips_outliers() -> None:
    import polars as pl
    from qtrader.input.features.statistical.transforms import winsorize
