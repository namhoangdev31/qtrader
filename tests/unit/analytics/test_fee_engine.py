...
from qtrader.analytics.fee_engine import FeeCalculationEngine
...
def test_fee_management_accuracy(engine: FeeCalculationEngine) -> None:
    ...
    assert report["fees"]["total_management_fee"] == 20.0  # noqa: S101, PLR2004
    assert report["fees"]["institutional_total"] == 20.0  # noqa: S101, PLR2004
...
def test_fee_performance_hwm_gating(engine: FeeCalculationEngine) -> None:
    ...
    assert report["fees"]["total_performance_fee"] == 100.0  # noqa: S101, PLR2004
    assert report["hwm_forensics"]["updated_hwm_basis"] == 500.0  # noqa: S101, PLR2004
...
def test_fee_performance_no_charge_during_recovery(engine: FeeCalculationEngine) -> None:
    ...
    assert report["fees"]["total_performance_fee"] == 0.0  # noqa: S101
    assert report["hwm_forensics"]["updated_hwm_basis"] == 1000.0  # noqa: S101, PLR2004
...
def test_fee_hwm_persistence(engine: FeeCalculationEngine) -> None:
    ...
    assert report["hwm_forensics"]["updated_hwm_basis"] == 800.0  # noqa: S101, PLR2004
...
def test_fee_telemetry_tracking(engine: FeeCalculationEngine) -> None:
    ...
    assert stats["total_fees_accumulated"] == 180.0  # noqa: S101, PLR2004
    assert stats["peak_hwm_observed"] == 800.0  # noqa: S101, PLR2004
