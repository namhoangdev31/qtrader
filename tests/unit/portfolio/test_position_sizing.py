...
def test_sizer_high_vol_throttling(sizer: RiskAdaptivePositionSizer) -> None:
    ...
    assert report["metrics"]["calculated_position_size"] == 0.01  # noqa: S101, PLR2004
    assert report["metrics"]["volatility_modulation_factor"] == 0.1  # noqa: S101, PLR2004
...
def test_sizer_low_vol_expansion(sizer: RiskAdaptivePositionSizer) -> None:
    ...
    assert report["metrics"]["calculated_position_size"] == 0.2  # noqa: S101, PLR2004
    assert report["metrics"]["volatility_modulation_factor"] == 2.0  # noqa: S101, PLR2004
...
def test_sizer_max_exposure_cap(sizer: RiskAdaptivePositionSizer) -> None:
    ...
    assert report["metrics"]["calculated_position_size"] == 1.0  # noqa: S101
    assert report["governance"]["size_max_applied"] == 1.0  # noqa: S101
...
def test_sizer_zero_vol_safety(sizer: RiskAdaptivePositionSizer) -> None:
    ...
    assert report["governance"]["volatility_floor_active"] is True  # noqa: S101
    assert report["metrics"]["calculated_position_size"] > 0  # noqa: S101
...
def test_sizer_telemetry_tracking(sizer: RiskAdaptivePositionSizer) -> None:
    ...
    assert stats["lifecycle_decision_count"] == 2  # noqa: S101, PLR2004
    assert stats["avg_position_size_observed"] == 0.055  # noqa: S101, PLR2004
    assert stats["avg_volatility_observed"] == 0.055  # noqa: S101, PLR2004
